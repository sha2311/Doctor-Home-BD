...
import RelatateDoctors from '../components/RelatateDoctors'
        ...
        for (let i = 0; i < 7; i++) {
          ...
          endTime.setHours(21,0,0,0)
            ...
            while (currentDate < endTime) {
              let fromatTime = currentDate.toLocaleTimeString([], {hour: '2-digit', minute: '2-digit'})
              ...
              //increament current time br 30 min
    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row gap-4'>
       ...
       <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
           ...
           <RelatateDoctors docId={docId} speciality ={docInfo.speciality} />
    </div>
  )
}
